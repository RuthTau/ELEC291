...
Alarm: 
	...
	clock_hour:
	setb HOUR_ALARM
	jnb HOUR_ALARM, clock_min_button
	Wait_Milli_Seconds(#100)
	jnb HOUR_ALARM, clock_min_button
	ljmp clock_min_button
	...
	da a
	mov A_h,a
	cjne a, #0x13, no_hours_overflow
	mov a, #0x01
	Set_Cursor(2,7)
	Display_BCD(A_h)
	ljmp minutes_for_alarm
	...
	minutes_for_alarm:
	setb MIN_ALARM
	jb MIN_ALARM, do_not_increment_hours
	Wait_Milli_Seconds(#50)
	jb  MIN_ALARM, do_not_increment_hours
	jnb  MIN_ALARM, $
	mov a, A_m
